export default function TeamInfo(props) {
  return (
    <div className="grid grid-cols-12 bg-teaminfo-default p-2 relative items-center">
      <div className=" bg-gradient-to-r from-orange-500 to-amber-700 font-bold"><span>{props.teamPlace}</span></div>
      <div className="flex content-start col-span-3 font-semibold">{props.teamName}</div>
      <div className="flex items-center content-center col-span-2"><img className="max-w-20" alt={props.teamName + "-Logo"} src={props.teamIconURL} /></div>
